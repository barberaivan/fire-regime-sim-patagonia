...
management scenarios needs spatially explicit fire spread models that 
...
Patagonia using the regionally available inputs, and a fitting method
that needs only final fire perimeters and ignition location.
\textbf{Methods.} We developed a stochastic cellular automaton where parameters
vary among fires in a hierarchical formulation. It was fitted with the Lunn 
method and Approximate Bayesian Computation, based on 57 fires with known 
ignition location, with 178 further fires informing fire size. 
The model was validated by comparing fire size and shape 
between simulated and observed fires.
