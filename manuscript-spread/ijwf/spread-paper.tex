...
\affil[A]{Instituto de Investigaciones en Biodiversidad y Medioambiente, CONICET -- Universidad Nacional del Comahue, San Carlos de Bariloche, Río Negro, Argentina}{\auorc{0000-0002-7572-4471}{} \auorc{0000-0002-9754-4121}{}}
...
Supplementary material is available online. It gives the technical detail of the
methods: the wind field and the accumulated Fire Weather Index, and the model behind the
two flammability indices with its coefficients (Table~S1, Fig.~S1, Section~1); the priors
and the two-stage estimation procedure, with the samplers used in each stage (Section~2);
the definition of every validation statistic (Section~3); and the vegetation comparison
on which Fig.~\ref{fig:vegeffect} rests (Section~4). Section~5 holds the extended
results, and a further analysis of the validation: the shape of the simulated fires split
by what brought each of them to a stop (Table~S2, Fig.~S6).
