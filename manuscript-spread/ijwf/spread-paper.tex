...
vary among fires in a hierarchical formulation. It was fitted by Approximate 
Bayesian Computation in two stages, based on 57 fires with known 
ignition location, with 178 further fires informing fire size. 
The model was validated by comparing size and shape 
...
\citep{bazin2010likelihood, turner2014hierarchical}, and the two-stage scheme of
\citet{lunn2013fully}, used in ecology to fit hierarchical movement models
\citep{hooten2016hierarchical}, makes that practical when each unit's posterior is expensive: with fire-wise ABC posteriors as
