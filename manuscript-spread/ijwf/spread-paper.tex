...
smaller fires (with ignition point) pulling the steps distribution to the small side.
...
same landscapes. 
% [Claude, get that Laneri paper, read it and check if that comparison is true.]
...
matter it drives spread probability towards 1 downwind and 0 upwind, with lateral
cells at probability
%[Claude, compute this prob from the equation, if wind speed is very large, what value
%takes hte lateral cells?]
Under this condition, simulated fires in flat and homogeneous fuel make a funnel shape
widening downwind, but can never make highly estirada shape,
%[Claude, what word here for estirada?]
and its elongation is fixed by geometry at about 1.9. Simulations on a flat synthetic landscape confirm the ceiling:
