...
The fourth is the estimation method, which we believe is new. Hierarchical models have been
fitted by ABC before, but in the published schemes the simulator runs inside the sampler
\citep{bazin2010likelihood, turner2014hierarchical, clarte2021componentwise}, and the
two-stage scheme of \citet{lunn2013fully}, used in ecology to fit hierarchical movement
...
new fires can be added without refitting the old ones. All of them could be adopted with a
better spread engine.
