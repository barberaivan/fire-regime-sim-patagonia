...
source_dir <- file.path("files", "fire_regime_simulation")
...
tab <- readRDS(file.path("files", "fire_regime_simulation",
...
# )
# saveRDS(bprop_model, file.path("files", "fire_regime_simulation",
#                                "burn_prop_model.rds"))
...
#   chains = 4, iter = 2000, warmup = 1000, refresh = 50, cores = 4
# )
# saveRDS(lprop_model, file.path("files", "fire_regime_simulation",
...
bprop_model <- readRDS(file.path("files", "fire_regime_simulation",
                                 "burn_prop_model.rds"))
lprop_model <- readRDS(file.path("files", "fire_regime_simulation",
                                 "burn_prop_model_lightning.rds"))
