...
saveRDS(tab_export, file.path("files", "fire_regime_simulation",
...
tab_buff <- readRDS(file.path("files", "fire_regime_simulation",
                              "lightning_proportion_merged.rds"))
tab_pnnh <- readRDS(file.path("files", "fire_regime_simulation",
                              "burn_prop_distribution_merged.rds"))
