...
saveRDS(data_summ, file.path("data", "flammability_indices",
...
smodel <- stan_model(file.path("data_prep", "flammability_indices.stan"))
...
saveRDS(mod, file.path("data", "flammability_indices",
                       "flammability_indices_samples.rds"))
mod <- readRDS(file.path("data", "flammability_indices",
                         "flammability_indices_samples.rds"))
...
saveRDS(theta_hat, file.path("data", "flammability_indices",
