...
# saveRDS(
#   stansteps,
#   file.path("files", "hierarchical_model", "steps_model_stan_samples.rds")
# )
stansteps <- readRDS(
  file.path("files", "hierarchical_model", "steps_model_stan_samples.rds")
)
...
saveRDS(run0, file.path("files", "hierarchical_model", "run0.rds"))
run0 <- readRDS(file.path("files", "hierarchical_model", "run0.rds"))
...
saveRDS(sd_jump_tune, file.path("files", "hierarchical_model", "sd_jump_tune.rds"))

# Run MCMC in parallel ----------------------------------------------------

run0 <- readRDS(file.path("files", "hierarchical_model", "run0.rds"))
sd_jump_tune <- readRDS(file.path("files", "hierarchical_model", "sd_jump_tune.rds"))
...
for(batch in 1:nb) {
  ...
  if(batch == 1) {
    ...
    draws_prev <- readRDS(file.path("files", "hierarchical_model", fname_prev))
    # get last iters
...
saveRDS(draws, file.path(
  "files", "hierarchical_model", "spread_model_samples.rds"
))
...
size_obs <- readRDS(file.path("files", "hierarchical_model", "size_obs.rds"))
veg_available <- readRDS(file.path("files", "hierarchical_model", "veg_available.rds"))
